      ...
      <body className={`${inter.className} selection:bg-gold-500/30`}>
        <nav className="fixed top-0 w-full z-50 glass border-b border-white/5 px-6 py-4">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <a href="/" className="flex items-center space-x-2 group">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#d4af37] to-[#b8860b] flex items-center justify-center font-black text-black text-xl shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                P
              </div>
              <span className="text-xl font-black tracking-tight group-hover:gold-text transition-all duration-300">
                PRAVAH <span className="text-[10px] font-light text-gray-500 uppercase tracking-[0.4em] block -mt-1 ml-0.5">Analytics</span>
              </span>
            </a>
            ...
            <a href="/predict" className="gold-button text-[10px] py-2 px-6 uppercase tracking-widest">
              Get Valuation
            </a>
          </div>
        </nav>
        ...
        <footer className="glass border-t border-white/5 py-16 mt-20">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="gold-text text-2xl mb-4">PRAVAH.</p>
            ...
            <div className="flex justify-end space-x-8 text-[10px] font-bold text-gray-600 uppercase tracking-widest">
